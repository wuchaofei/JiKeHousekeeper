...
//com.jike.shanglv_b.Common.MyRolateAnimImageView
public class MyRolateAnimImageView extends ImageView {
...
//	private int rotateDegree = 10;
	...
	public MyRolateAnimImageView(Context context) {
		super(context);
		camera = new Camera();
	}

	public MyRolateAnimImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		camera = new Camera();
	}
