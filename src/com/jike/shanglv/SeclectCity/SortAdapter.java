...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
	private List<AirportCityModel> list = null;
	private Context mContext;
	
	public SortAdapter(Context mContext, List<AirportCityModel> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<AirportCityModel> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final AirportCityModel mContent = list.get(position);
		if (view == null) {
